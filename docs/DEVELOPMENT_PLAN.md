...
- [x] 复用 Node 22 CI 验证并合并为 `d46ccc810e990e0b3bf163416560f49d1cfe57cb`。
...
- [x] 未知查询没有自由文本添加入口，不会获得 nutrition authority；
- [x] 用户补录项明确标为 `user-added`，AI recognition confidence 为 0，默认克重/用油明确标为客户端 `review-derived`；
